...
public class Information_Schema_Table {
			...
			public static void main(String[] args) throws Exception  {
				        ...
				        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/information_schema?useSSL=false", "root", "Raviteja@2001");
				       ...
				       // System.out.println("CourseID\tCourseTitle\tCredits");
				        System.out.println("-----------------------------------------------------------");
				        while (rs.next()) {
